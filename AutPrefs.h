...
public:
	...
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x3f, DISPATCH_METHOD, VT_EMPTY, NULL, parms, FilePath);
	}
	void SaveProxies(LPCTSTR FilePath)
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x40, DISPATCH_METHOD, VT_EMPTY, NULL, parms, FilePath);
	}
	VARIANT GetProxyList()
	{
		VARIANT result;
		InvokeHelper(0x41, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
		return result;
	}
	void SetProxyList(VARIANT * pNewVal)
	{
		static BYTE parms[] = VTS_PVARIANT ;
		InvokeHelper(0x42, DISPATCH_METHOD, VT_EMPTY, NULL, parms, pNewVal);
	}
...
BOOL GetAntivirusEnabled()
{
	BOOL result;
	GetProperty(0x43, VT_BOOL, (void*)&result);
	return result;
}
void SetAntivirusEnabled(BOOL propVal)
{
	SetProperty(0x43, VT_BOOL, propVal);
}
CString GetAntivirusPath()
{
	CString result;
	GetProperty(0x44, VT_BSTR, (void*)&result);
	return result;
}
void SetAntivirusPath(CString propVal)
{
...
void SetLatitude(double propVal)
{
...
void SetLongitude(double propVal)
{
	SetProperty(0x46, VT_R8, propVal);
}
CString GetNetworkName()
{
	CString result;
	GetProperty(0x47, VT_BSTR, (void*)&result);
	return result;
}
void SetNetworkName(CString propVal)
{
