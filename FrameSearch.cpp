...
IMPLEMENT_DYNCREATE(CFrameSearch, CGnuMdiChildWnd)

CFrameSearch::CFrameSearch()
{
}
...
BEGIN_MESSAGE_MAP(CFrameSearch, CGnuMdiChildWnd)
	//{{AFX_MSG_MAP(CFrameSearch)
	//}}AFX_MSG_MAP
	ON_WM_SIZING()
END_MESSAGE_MAP()


BOOL CFrameSearch::PreCreateWindow(CREATESTRUCT& cs) 
{
...
void CFrameSearch::OnSizing(UINT fwSide, LPRECT pRect) 
{
